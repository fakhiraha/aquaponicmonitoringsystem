        ...
        <table class="styled-table">
            ...
            <tbody>
                ...
                if ($recordLimit === 'today') {
                    ...
                    $sql = "SELECT ID, datetime, distance FROM waterlevel WHERE DATE(datetime) = '$todayDate' ORDER BY datetime DESC";
                } elseif ($recordLimit === 'all') {
                    $sql = "SELECT ID, datetime, distance FROM waterlevel ORDER BY datetime DESC";
                } else {
                    $sql = "SELECT ID, datetime, distance FROM waterlevel ORDER BY datetime DESC LIMIT $recordLimit";
                }
