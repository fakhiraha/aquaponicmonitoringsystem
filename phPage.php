        ...
        <table class="styled-table">
            ...
            <tbody>
                ...
                if ($recordLimit === 'today') {
                    ...
                    $sql = "SELECT ID, datetime, ph_act FROM ph WHERE DATE(datetime) = '$todayDate' ORDER BY datetime DESC";
                } elseif ($recordLimit === 'all') {
                    $sql = "SELECT ID, datetime, ph_act FROM ph ORDER BY datetime DESC";
                } else {
                    $sql = "SELECT ID, datetime, ph_act FROM ph ORDER BY datetime DESC LIMIT $recordLimit";
                }
